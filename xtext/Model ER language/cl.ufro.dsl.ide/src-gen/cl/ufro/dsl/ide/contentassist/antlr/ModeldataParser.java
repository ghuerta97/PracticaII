 ...
 */
package cl.ufro.dsl.ide.contentassist.antlr;

import cl.ufro.dsl.ide.contentassist.antlr.internal.InternalModeldataParser;
...
public class ModeldataParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ModeldataGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ModeldataGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalModeldataParser createParser() {
		InternalModeldataParser result = new InternalModeldataParser(null);
