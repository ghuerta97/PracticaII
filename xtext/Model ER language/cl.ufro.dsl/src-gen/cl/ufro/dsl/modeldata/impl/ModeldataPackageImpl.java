 ...
 * @generated
 */
public class ModeldataPackageImpl extends EPackageImpl implements ModeldataPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see cl.ufro.dsl.modeldata.ModeldataPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private ModeldataPackageImpl()
  {
    super(eNS_URI, ModeldataFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link ModeldataPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static ModeldataPackage init()
  {
    if (isInited) return (ModeldataPackage)EPackage.Registry.INSTANCE.getEPackage(ModeldataPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredModeldataPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    ModeldataPackageImpl theModeldataPackage = registeredModeldataPackage instanceof ModeldataPackageImpl ? (ModeldataPackageImpl)registeredModeldataPackage : new ModeldataPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theModeldataPackage.createPackageContents();

    // Initialize created meta-data
    theModeldataPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theModeldataPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(ModeldataPackage.eNS_URI, theModeldataPackage);
    return theModeldataPackage;
  }
   ...
   */
  @Override
  public ModeldataFactory getModeldataFactory()
  {
    return (ModeldataFactory)getEFactoryInstance();
  }
